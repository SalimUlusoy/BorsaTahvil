<%@ Page Title="" Language="C#" MasterPageFile="~/BorsaTahvil.Master" AutoEventWireup="true" CodeBehind="MakaleOku.aspx.cs" Inherits="BorsaTahvilAlphaV1.MakaleOku" %>
      ...
      <li class="nav-item active">
       ...
       style=" width:100%">
                ...
                <asp:TemplateField HeaderText="Başlık">  
                    ...
                    <EditItemTemplate>  
                        <asp:TextBox ID="txt_Baslik" ReadOnly="true" runat="server" Text='<%#Eval("Baslik") %>'></asp:TextBox>  
                    </EditItemTemplate>  
                </asp:TemplateField>  
