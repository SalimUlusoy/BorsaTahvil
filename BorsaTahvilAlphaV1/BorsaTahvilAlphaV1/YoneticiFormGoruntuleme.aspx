<%@ Page Title="" Language="C#" MasterPageFile="~/BorsaTahvil.Master" AutoEventWireup="true" CodeBehind="YoneticiFormGoruntuleme.aspx.cs" Inherits="BorsaTahvilAlphaV1.YoneticiFormGoruntuleme" %>
...
<div id="main">
  ...
  <div class="collapse navbar-collapse" id="navbarNavDropdown">
    ...
    <div class="FormGoruntule" style="margin-bottom:5%; margin-top:5%; position:relative; margin:auto; align-items:center; display:flex">
        <iframe src="https://docs.google.com/spreadsheets/d/e/2PACX-1vStGEINv84_gPfYCJdUY44KSL-riUsQQDKVsPY0BgIwIl86BBrPfrSLg1821_eSaDvlFfKMUpSm-Z27/pubhtml?widget=true&amp;headers=false" width="75%" height="auto" frameborder="0" marginheight="0" marginwidth="0" style="position:relative; margin:auto"></iframe>
    </div>
