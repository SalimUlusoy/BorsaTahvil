<%@ Page Title="" Language="C#" MasterPageFile="~/BorsaTahvil.Master" AutoEventWireup="true" CodeBehind="YoneticiEditorMakale.aspx.cs" Inherits="BorsaTahvilAlphaV1.YoneticiEditorMakale" %>
      ...
      <li class="nav-item active">
       ...
       style=" width:100%">
                ...
                <asp:TemplateField HeaderText="Başlık">  
                    <ItemTemplate>  
                        <asp:Label ID="lbl_Baslik" runat="server" Text='<%#Eval("Baslik") %>'></asp:Label>  
                    </ItemTemplate>  
                    <EditItemTemplate>  
                        <asp:TextBox ID="txt_Baslik" runat="server" Text='<%#Eval("Baslik") %>'></asp:TextBox>  
                    </EditItemTemplate>  
                </asp:TemplateField>  
                <asp:TemplateField HeaderText="Makale Gövdesi">  
                    <ItemTemplate>  
                        <asp:Label ID="lbl_MakaleGovde" runat="server" Text='<%#Eval("MakaleGovde") %>'></asp:Label>  
                    </ItemTemplate>  
                    <EditItemTemplate>  
                        <asp:TextBox ID="txt_MakaleGovde" runat="server" Text='<%#Eval("MakaleGovde") %>'></asp:TextBox>  
                    </EditItemTemplate>  
                </asp:TemplateField>
