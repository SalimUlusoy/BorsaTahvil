<%@ Page Title="" Language="C#" MasterPageFile="~/BorsaTahvil.Master" AutoEventWireup="true" CodeBehind="YoneticiPostUpdate.aspx.cs" Inherits="BorsaTahvilAlphaV1.YoneticiPostUpdate" %>
      ...
      <li class="nav-item active">
       ...
       style=" width:100%">
                ...
                <asp:TemplateField HeaderText="PostIsim">  
                    ...
                    <EditItemTemplate>  
                        <asp:TextBox ID="txt_Post_isim" runat="server" Text='<%#Eval("Post_isim") %>'></asp:TextBox>  
                    </EditItemTemplate>  
                </asp:TemplateField>  
